window.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (!searchInput || !searchColor || !searchImage || !typeSelect || !typeText || !countSelect || !randomBtn || !paletteContainer || !relatedContainer) {
    ...
    */
    ...
    randomBtn.addEventListener("click", () => {
        ...
        const paletteColors = paletteContainer.querySelectorAll(".color");
        ...
        const relatedColors = relatedContainer.querySelectorAll(".color");
    ...
    palettes.forEach((palette) => {
        palette.addEventListener("click", (e) => {
            ...
            if (target.classList.contains("copy-color")) {
                ...
                toast(`Copied color : [${color}] copied to clipboard`);
            }
    ...
    function downloadPaletteSvg(colors, name) {
        const svg = document.createElementNS("http://www.w3.org/2000/svg", "canvas");
